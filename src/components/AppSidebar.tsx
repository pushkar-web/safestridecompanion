import { Home, Map, MessageCircle, Navigation, Settings, Shield, Users, Bell, User, LogOut, Sparkles, Flame, Trophy, AlertOctagon } from "lucide-react";
...
const navItems = [
  ...
  { to: "/heatmap", icon: Flame, label: "Safety Heatmap" },
  { to: "/emergency", icon: AlertOctagon, label: "Emergency", danger: true },
